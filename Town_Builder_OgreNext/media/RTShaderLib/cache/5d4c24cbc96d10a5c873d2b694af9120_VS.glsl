...
void main(void) {
	...
	FFP_Transform(world_matrix_array_3x4[int(blendIndices.z)], vertex, TempVal4.xyz);
	TempVal4.w	=	1.00000;
	TempVal4	=	TempVal4*blendWeights.z;
	lLocalParam_0	=	TempVal4+lLocalParam_0;
	FFP_Transform(world_matrix_array_3x4[int(blendIndices.w)], vertex, TempVal4.xyz);
	TempVal4.w	=	1.00000;
	TempVal4	=	TempVal4*blendWeights.w;
	lLocalParam_0	=	TempVal4+lLocalParam_0;
	...
	FFP_Transform(world_matrix_array_3x4[int(blendIndices.z)], normal, TempVal3);
	TempVal3	=	TempVal3*blendWeights.z;
	lLocalParam_1	=	TempVal3+lLocalParam_1;
	FFP_Transform(world_matrix_array_3x4[int(blendIndices.w)], normal, TempVal3);
	TempVal3	=	TempVal3*blendWeights.w;
	lLocalParam_1	=	TempVal3+lLocalParam_1;
