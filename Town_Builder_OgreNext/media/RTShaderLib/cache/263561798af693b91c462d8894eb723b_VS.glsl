...
void main(void) {
	...
	blendS	=	TempVal3x4;
	TempVal3x4	=	world_scale_shear_matrix_array_3x4[int(blendIndices.y)];
	TempVal3x4	=	blendWeights.y*TempVal3x4;
	blendS	=	TempVal3x4+blendS;
	TempVal3x4	=	world_scale_shear_matrix_array_3x4[int(blendIndices.z)];
	TempVal3x4	=	blendWeights.z*TempVal3x4;
	blendS	=	TempVal3x4+blendS;
	TempVal3x4	=	world_scale_shear_matrix_array_3x4[int(blendIndices.w)];
	TempVal3x4	=	blendWeights.w*TempVal3x4;
	blendS	=	TempVal3x4+blendS;
