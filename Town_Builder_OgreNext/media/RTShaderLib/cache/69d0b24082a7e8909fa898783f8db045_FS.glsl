...
void main(void) {
	...
	SGX_Light_Point_DiffuseSpecular(lLocalParam_2, iTexcoord_1, iTexcoord_3, light_attenuation1, derived_light_diffuse_colour1.xyz, derived_light_specular_colour1.xyz, surface_shininess, oColor_0.xyz, lLocalParam_1.xyz);
