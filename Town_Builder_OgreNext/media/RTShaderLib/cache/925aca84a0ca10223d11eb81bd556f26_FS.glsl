...
void main(void) {
	...
	SGX_Light_Point_DiffuseSpecular(iTexcoord_0, lLocalParam_3, lLocalParam_2, light_attenuation, derived_light_diffuse_colour.xyz, derived_light_specular_colour.xyz, surface_shininess, oColor_0.xyz, lLocalParam_1.xyz);
	SGX_Light_Directional_DiffuseSpecular(iTexcoord_0, lLocalParam_3, light_position_view_space1.xyz, derived_light_diffuse_colour1.xyz, derived_light_specular_colour1.xyz, surface_shininess, oColor_0.xyz, lLocalParam_1.xyz);
