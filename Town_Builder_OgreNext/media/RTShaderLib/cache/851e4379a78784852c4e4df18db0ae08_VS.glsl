...
void main(void) {
	...
	FFP_Transform(inv_world_rotation_matrix0, lNormalMapTempDir, lNormalMapTempDir);
	FFP_Transform(lMatTBN, lNormalMapTempDir, iTexcoord_1);
	FFP_Transform(lMatTBN, light_direction_obj_space0.xyz, iTexcoord_2);
	iTexcoord_0	=	uv0.xy;
	FFP_GenerateTexCoord_EnvMap_Reflect(world_matrix, inverse_transpose_world_matrix, view_matrix, normal, vertex, iTexcoord_3);
	FFP_TransformTexCoord(texture_matrix1, iTexcoord_3, iTexcoord_3);
	iTexcoord_0	=	uv0.xy;
}
